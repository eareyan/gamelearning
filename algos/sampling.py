...
def global_sampling(game_input, delta, num_samples, hoeffding_inequality=False, noise_function=None):
...
def progressive_sampling(game_input, eps, delta, initial_num_samples, max_num_samples, HoeffdingIneq=False,
    ...
    while (True):
        ...
        if (num_samples > max_num_samples):
            ...
            (eps_t, conf_t, dict_individual_estimated_eps_brgs_t) = global_sampling(game_input, delta / n, num_samples, HoeffdingIneq)
            if verbose:
